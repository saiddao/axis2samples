...
public class VersionStub extends Stub {
	...
	private void populateAxisService() throws AxisFault {
		...
		_service = new AxisService("Version"
				+ getUniqueSuffix());
	...
	private void populateFaults() {
		...
		faultExceptionNameMap.put(new QName(
				"http://axisversion.sample", "Exception"),
				"sample.axisversion.ExceptionException0");
		faultExceptionClassNameMap.put(new QName(
				"http://axisversion.sample", "Exception"),
				"sample.axisversion.ExceptionException0");
	...
	public sample.axisversion.VersionStub.GetVersionResponse getVersion(
	...
	, sample.axisversion.ExceptionException0 {
		...
		try {
			...
			java.lang.Object object = fromOM(_returnEnv.getBody()
					.getFirstElement(),
					sample.axisversion.VersionStub.GetVersionResponse.class,
					getEnvelopeNamespaces(_returnEnv));

			return (sample.axisversion.VersionStub.GetVersionResponse) object;
			...
			if (faultElt != null) {
				if (faultExceptionNameMap.containsKey(faultElt.getQName())) {
					...
					try {
						...
						if (ex instanceof sample.axisversion.ExceptionException0) {
							throw (sample.axisversion.ExceptionException0) ex;
						}
	...
	final sample.axisversion.VersionCallbackHandler callback)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback
									.receiveResultgetVersion((sample.axisversion.VersionStub.GetVersionResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap.containsKey(faultElt
									...
									try {
										...
										if (ex instanceof sample.axisversion.ExceptionException0) {
											callback
													.receiveErrorgetVersion((sample.axisversion.ExceptionException0) ex);
											return;
										}

										callback
												.receiveErrorgetVersion(new java.rmi.RemoteException(
														ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
	...
	public static class ExceptionE implements
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://axisversion.sample", "Exception", "ns1");
	...
	public static class GetVersionResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://axisversion.sample", "getVersionResponse", "ns1");
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":getVersionResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "getVersionResponse", xmlWriter);
				}
	...
	private org.apache.axiom.om.OMElement toOM(
			sample.axisversion.VersionStub.GetVersionResponse param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(
					sample.axisversion.VersionStub.GetVersionResponse.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			sample.axisversion.VersionStub.ExceptionE param,
			boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(
					sample.axisversion.VersionStub.ExceptionE.MY_QNAME,
					org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (sample.axisversion.VersionStub.GetVersionResponse.class
					.equals(type)) {

				return sample.axisversion.VersionStub.GetVersionResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (sample.axisversion.VersionStub.ExceptionE.class.equals(type)) {

				return sample.axisversion.VersionStub.ExceptionE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
